  ...
  site.page("newsletter.html", {
    ...
    <section class="section section--sand">
      <div class="wrap issue">
        ...
        <div class="mail reveal" data-delay="1" aria-hidden="true">
          <div class="mail__bar"><i></i><i></i><i></i><span>La Carta de Grau · Edición de otoño</span></div>
          <div class="mail__body">
            <img src="assets/img/logo.svg" alt="" width="68" height="22">
            <p class="mail__date">Septiembre 2026</p>
            <div class="mail__hero"><img src="assets/img/alianzas.jpg" alt="" width="2000" height="1075" loading="lazy" decoding="async"></div>
            <p class="mail__title">El oro que os acompaña</p>
            <p>Descubre la nueva selección de alianzas y cómo elegir la vuestra.</p>
            <span class="mail__btn">Descubrir</span>
            <div class="mail__cols">
              <div><img src="assets/img/anillos.jpg" alt="" width="960" height="1280" loading="lazy" decoding="async"><span>Anillos</span></div>
              <div><img src="assets/img/collares.jpg" alt="" width="960" height="1280" loading="lazy" decoding="async"><span>Collares</span></div>
              <div><img src="assets/img/pulseras.jpg" alt="" width="960" height="1280" loading="lazy" decoding="async"><span>Pulseras</span></div>
            </div>
          </div>
        </div>
      </div>
